...
Anda juga harus memperhatikan bahwa &myAge sering disebut "pointer". Pointer pada dasarnya menyimpan alamat memori suatu variabel sebagai nilainya. Untuk mencetak nilai pointer, kita menggunakan %p penentu format.
